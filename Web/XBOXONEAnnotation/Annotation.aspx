<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Annotation.aspx.cs" Inherits="XBOXONEAnnotation.Annotation" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            timeid = getURLParameters('Timeid');
            var subject = getURLParameters('subject');
            var body = getURLParameters('body');
            //timeid = '417280865'
            //PageMethods.userload(417280865, subject, CallloadSuccess, CallFailed);
            PageMethods.userload(timeid, subject, CallloadSuccess, CallFailed);
        ...
        function CallloadSuccess(res) {
            ...
            document.getElementById('txalias').value = document.getElementById('idaliash').value;

            if (annotation[2].length > 0) {
                document.getElementById('idsubject').value = annotation[2];
            }
        }

        function usersubmit() {
            var content, alias, subject;
            var iframe = document.getElementById('rte1');
            var doc = iframe.contentWindow.document;
        ...
        function userdelete() {
            ...
            timeid = document.getElementById('hdnrte1').value;
            subject = document.getElementById('idsubject').value;
            if (subject.length != 0 && alias.length != 0)
...
<body>
    ...
    <table>
             <tr><td colspan="3" style="text-align:center; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size:large; font-weight: bold; color: #008000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LSDSI Annotation</td></tr>
             ...
             <tr>
                 ...
                 <td></td>
                 <td><input type="text" id="txalias" style="width:200px; height:25px;font-size:larger" value="" /></td>
             </tr>
    ...
    <div style="position:absolute" id="idsubmitable">
        ...
        <asp:TextBox ID="idaliash" runat="server" style="visibility:hidden;"></asp:TextBox>
